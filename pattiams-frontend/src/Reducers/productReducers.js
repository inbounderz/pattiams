...
export const listCategory2Reducer = (state = {categories: []}, action) => {
  switch (action.type) {
    case CATEGORY_BY_CATEGORY2_REQUEST:
      return { loading: true, categories: [] };
    case CATEGORY_BY_CATEGORY2_SUCCESS:
      return { loading: false, categories: action.payload };
    case CATEGORY_BY_CATEGORY2_FAIL:
      return { loading: false, error: action.payload };
    default:
      return state;
  }
...
export const listProductsByCategoryReducer = (state = {products: []}, action) => {
  switch (action.type) {
    case PRODUCT_BY_CATEGORY2_REQUEST:
      return { loading: true, products: [] };
    case PRODUCT_BY_CATEGORY2_SUCCESS:
      return { loading: false, products: action.payload };
    case PRODUCT_BY_CATEGORY2_FAIL:
      return { loading: false, error: action.payload };
    default:
      return state;
  }
