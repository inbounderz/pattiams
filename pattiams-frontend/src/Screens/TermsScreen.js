  ...
  return (
    <Container className="my-5">
      ...
      <p>
        ...
        of pattiams's Website, www.pattiams.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use pattiams if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing pattiams, you agreed to use
        cookies in agreement with the pattiams's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, pattiams and/or its licensors own the
        intellectual property rights for all material on pattiams. All
        intellectual property rights are reserved. You may access this from
        pattiams for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from pattiams</li>
        <li>Sell, rent or sub-license material from pattiams</li>
        <li>Reproduce, duplicate or copy material from pattiams</li>
        <li>Redistribute content from pattiams</li>
      </ul>

      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        pattiams does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of pattiams,its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, pattiams shall not be liable
      ...
      <p>
        pattiams reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant pattiams a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of pattiams; and (d) the link is
      ...
      <p>
        ...
        e-mail to pattiams. Please include your name, your organization name,
      ...
      <p>
        No use of pattiams's logo or other artwork will be allowed for linking
